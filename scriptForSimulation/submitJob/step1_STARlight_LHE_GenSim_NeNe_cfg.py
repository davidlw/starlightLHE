...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/user/d/davidlw/starlightLHE_Phi2KK/generateLHE/CohPhi2KKinOOAt5p36TeV/lheFiles/slight_CohPhi2KKinOOAt5p36TeV_0001.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HINPbPbAutumn18GS_STARlight_fragment.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_STARlight_LHE_GenSim.root'),
...
process.kaonminusfilter = cms.EDFilter("MCSingleParticleFilter",
...
process.kaonplusfilter = cms.EDFilter("MCSingleParticleFilter",
    MaxEta = cms.untracked.vdouble(2.5),
    MinEta = cms.untracked.vdouble(-2.5),
    MinPt = cms.untracked.vdouble(0.05),
    ParticleID = cms.untracked.vint32(321),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.kaonplusfilter+process.kaonminusfilter)
