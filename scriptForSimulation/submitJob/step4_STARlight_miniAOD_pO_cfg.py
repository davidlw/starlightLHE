...
# with command line options: step4 --filein file:step3_STARlight_Reco.root --fileout step4_STARlight_miniAOD.root --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 150X_mcRun3_2025_forOO_realistic_v9 --step PAT --geometry DB:Extended --era Run3_2025_UPC_OXY --python_filename step4_STARlight_miniAOD_cfg.py --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_2025_UPC_OXY_cff import Run3_2025_UPC_OXY

process = cms.Process('PAT',Run3_2025_UPC_OXY)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step3_STARlight_Reco.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step4_STARlight_miniAOD.root'),
